-- ============================================================================
-- Camélia Handcraft — corrige valor do enum transaction_type
-- ============================================================================
-- O enum transaction_type só aceita 'receita'/'despesa' (minúsculo) — as
-- funções da última rodada gravavam 'Receita' (maiúsculo), que não existe
-- no enum e quebrava toda venda finalizada com "invalid input value for
