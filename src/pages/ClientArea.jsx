...
function ClientArea() {
  ...
  const IconHeart = () => (
    <svg className="menu-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>
  );
  const IconMap = () => (
      ...
      <div className="auth-card" style={{ maxWidth: '900px', textAlign: 'left', width: '100%' }}>
        ...
        <div className="client-grid">
          <div className="sidebar-menu">
            ...
            <button className="menu-btn" onClick={() => navigate('/minha-conta/favoritos')}><IconHeart /> Meus Favoritos</button>
