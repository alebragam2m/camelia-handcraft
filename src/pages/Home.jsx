...
function Home() {
  return (
    <div className="bg-fundo min-h-screen">
      ...
      <section className="relative bg-secundaria text-branco py-36 px-6 lg:px-12 flex flex-col items-center justify-center text-center overflow-hidden">
        <div className="absolute inset-0 opacity-10 bg-[url('https://www.transparenttextures.com/patterns/stardust.png')] mix-blend-overlay"></div>
        <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
          <h1 className="text-xs md:text-sm tracking-[6px] uppercase font-bold text-[#D8B4E2] mb-6">Feito à mão com amor</h1>
          <h2 className="text-6xl md:text-8xl font-serif font-bold mb-10 tracking-tight italic">
            Camélia Handcraft
          </h2>
      ...
      <section id="sobre" className="py-24 bg-branco border-t border-gray-100 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          ...
          <div className="flex border-t border-gray-200 mt-16 pt-10 gap-16 overflow-x-auto">
            <div>
              <h4 className="text-4xl font-bold text-primaria font-sans mb-1">100%</h4>
              <p className="text-sm text-gray-500 uppercase tracking-widest font-medium">Feito à mão</p>
            </div>
            <div>
              <h4 className="text-4xl font-bold text-primaria font-sans mb-1">2</h4>
              <p className="text-sm text-gray-500 uppercase tracking-widest font-medium">Gerações</p>
            </div>
            <div>
              <h4 className="text-4xl font-bold text-primaria font-sans mb-1">Único</h4>
              <p className="text-sm text-gray-500 uppercase tracking-widest font-medium">Cada peça</p>
            </div>
          </div>
        </div>
      </section>
