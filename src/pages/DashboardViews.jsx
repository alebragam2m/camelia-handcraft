  ...
  <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', height: '100%' }}>
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '15px' }}>
      <div style={{ backgroundColor: branco, padding: '15px', borderRadius: '12px', border: `1px solid ${borda}`, textAlign: 'center' }}>
        ...
        <h3 style={{ color: veryPeri, fontSize: '20px' }}>{formatCurrency(fin.faturamento)}</h3>
      </div>
      <div style={{ backgroundColor: branco, padding: '15px', borderRadius: '12px', border: `1px solid ${borda}`, textAlign: 'center' }}>
        <span style={{ fontSize: '10px', color: '#888', textTransform: 'uppercase' }}>Lucro Real</span>
        <h3 style={{ color: '#27AE60', fontSize: '20px' }}>{formatCurrency(lucroReal)}</h3>
      </div>
      <div style={{ backgroundColor: branco, padding: '15px', borderRadius: '12px', border: `1px solid ${borda}`, textAlign: 'center' }}>
    ...
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gridTemplateRows: '1fr 1fr', gap: '20px', flexGrow: 1 }}>
      <div style={{ backgroundColor: branco, padding: '25px', borderRadius: '16px', border: `1px solid ${borda}` }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', fontSize: '14px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between' }}><span>Acumulado:</span> <strong>{formatCurrency(fin.faturamento)}</strong></div>
          <div style={{ display: 'flex', justifyContent: 'space-between' }}><span>Pix:</span> <strong style={{color:'#27AE60'}}>{formatCurrency(fin.pix)}</strong></div>
          <div style={{ display: 'flex', justifyContent: 'space-between' }}><span>Cartão:</span> <strong>{formatCurrency(fin.cartao)}</strong></div>
      ...
      <div style={{ backgroundColor: branco, padding: '25px', borderRadius: '16px', border: `1px solid ${borda}` }}>
        ...
        <div style={{ marginBottom: '10px' }}>Ticket Médio: <strong>{formatCurrency(ticketMedio)}</strong></div>
